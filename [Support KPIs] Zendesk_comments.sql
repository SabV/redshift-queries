select *
	...
	from (select ztc.id, ztc.ticket_id, ztc.is_public, ztc.channel, u.first_name as agent, to_char(ztc.created_at, 'DD') as day, to_char(ztc.created_at, 'IW') as week, to_char(ztc.created_at, 'MM') as month, to_char(ztc.created_at, 'YYYY') as year
